...
База данных представляет собой контейнер для других объектов, таких как таблицы и представления, и без базы данных все эти объекты будут находиться в беспорядочном состоянии.
